...
public class Lexer {
    ...
    static void initTokenMaps(){
        ...
        tokenPatterns.put("^if$", "IF_LK");
        tokenPatterns.put("^else$", "ELSE_LK");
        tokenPatterns.put("^while$", "WHILE_LK");
        tokenPatterns.put("^do$", "DO_LK");
        tokenPatterns.put("^print$", "PRINT_LK");
        ...
        tokenPatterns.put("^int$|^float$|^string$|^char$|^bool$|^list$|^set$", "VAR_TYPE");
        // Приоритеты токенов
        tokenPriorities = new HashMap<>();
        tokenPriorities.put("WS", 0);
        tokenPriorities.put("VAR", 1);
        tokenPriorities.put("VAR_TYPE", 2);
        tokenPriorities.put("IF_LK", 3);
        tokenPriorities.put("ELSE_LK", 3);
        tokenPriorities.put("WHILE_LK", 3);
        tokenPriorities.put("DO_LK", 3);
        tokenPriorities.put("PRINT_LK", 3);
