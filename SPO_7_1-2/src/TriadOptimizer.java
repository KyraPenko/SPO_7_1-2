...
public class TriadOptimizer {
    ...
    static HashMap<String, LList<Integer>> list_vars;
    static HashMap<String, HSet<Integer>> set_vars;
        ...
        for(int i = 0; i < tokens.size(); i++){
            if(tokens.get(i).getSecond().equals(("!!")) || tokens.get(i).getSecond().equals(("!F")) ||
                ...
                while(!tokens.get(Integer.parseInt(new_ref.getSecond())).getFirst().equals("OP") &&
                        ...
                        !tokens.get(Integer.parseInt(new_ref.getSecond())).getFirst().equals("PRINT_LK") &&
...
//            }
            ...
            if (tokens.get(i).getFirst().equals("NUMBER") || tokens.get(i).getFirst().equals("VAR")) {
                ...
                // типы данных, безусловный переход, вывод данных
                        ...
                        tokens.get(i).getFirst().equals("PRINT_LK")) {
    ...
    public static void optimizeUnusedVars(){
        ...
        for(int i = 0; i < triads.size(); i++){
            ...
            if(triads.get(i).getOp().getFirst().equals("VAR_TYPE")){
                if(triads.get(i).getOp().getSecond().equals("int"))
                {
                    int_vars.put(triads.get(i).getA().getSecond(), 0);
                }
                else if(triads.get(i).getOp().getSecond().equals("float"))
                {
                    float_vars.put(triads.get(i).getA().getSecond(), 0.0f);
                }
                else if(triads.get(i).getOp().getSecond().equals("bool"))
                {
                    bool_vars.put(triads.get(i).getA().getSecond(), false);
                }
                else if(triads.get(i).getOp().getSecond().equals("list"))
                {
                    list_vars.put(triads.get(i).getA().getSecond(), new LList<Integer>());
                }
                else if(triads.get(i).getOp().getSecond().equals("set"))
                {
                    set_vars.put(triads.get(i).getA().getSecond(), new HSet<Integer>());
                }
            }
...
//                System.out.println(Integer.parseInt(triads.get(i).getA().getSecond()));
            ...
            else if(triads.get(i).getOp().getFirst().equals("LOGICAL_OP") || triads.get(i).getOp().getFirst().equals("PRINT_LK")){
                if(triads.get(i).getA() != null && triads.get(i).getA().getFirst().equals("VAR")){
